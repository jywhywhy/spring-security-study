...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        // userRequest 정보 -> loadUser 함수 -> 구글로부터 회원프로필 받음
        ...
        String providerId = oAuth2UserInfo.getProviderId(); // 312004403111271911956
        String username = provider + "_" + providerId; // google_312004403111271911956
        String password = bCryptPasswordEncoder.encode(UUID.randomUUID().toString()); //큰  의미 없음
        ...
        if (userEntity == null) {
            ...
            System.out.println("이미 자동회원가입이 되어 있음");
        }
